const getAccessToken = (z, bundle) => {
  const promise = z.request(`${process.env.BASE_URL}/common/oauth2/v2.0/token`, {
    method: 'POST',
    body: {
      ...
      scope: 'user.readwrite.all directory.read.all offline_access',
...
module.exports = {
  ...
  oauth2Config: {
    ...
    authorizeUrl: {
      url: `${process.env.BASE_URL}/common/oauth2/v2.0/authorize`,
      params: {
        client_id: '{{process.env.CLIENT_ID}}',
        redirect_uri: '{{bundle.inputData.redirect_uri}}',
        response_type: 'code',
