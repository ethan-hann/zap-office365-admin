const AssignlicenseCreate = require('./creates/assign_license');
const SkuResource = require('./resources/sku');
const UserResource = require('./resources/user');
// You'll want to set these with either `CLIENT_ID=abc zapier test` or `zapier env 1.0.0 CLIENT_ID abc`
process.env.BASE_URL = process.env.BASE_URL || 'https://login.microsoftonline.com';
...
const App = {
  ...
  creates: {
    [AssignlicenseCreate.key]: AssignlicenseCreate,
  }
};
